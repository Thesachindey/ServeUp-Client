...
const EventCard = ({ event }) => {
  ...
  return (
    ...
    >
      <Link to={`/event-details/${_id}`} className="card bg-base-100 w-full h-full shadow-md hover:shadow-xl border border-gray-100 rounded-2xl overflow-hidden transition-all duration-300 relative">
        ...
        <div className="card-body space-y-3">
          ...
          <div className="card-actions justify-between absolute bottom-5 left-3 right-3 ">
            ...
            <Link to={`/event-details/${_id}`}>
              <h1 className="text-blue-500 hover:text-blue-400 flex justify-center items-center">View event...</h1>
            </Link>
          </div>
        </div>
      </Link>
